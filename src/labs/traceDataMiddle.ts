...
.realestate-wrap { font-family: 'Helvetica Neue', Arial, sans-serif; background: #f3f4f6; color: #1f2937; min-height: 500px; }
...
body { margin: 0; }
.travel-site { font-family: 'Helvetica Neue', Arial, sans-serif; color: #333; min-height: 500px; }
...
.creative-bg { position: relative; min-height: 600px; background: #0f172a; overflow: hidden; font-family: 'Inter', sans-serif; display: flex; align-items: center; justify-content: center; padding: 20px; box-sizing: border-box; }
