  ...
  <nav class="local-nav">
    <div class="local-content">
      ...
      <div class="local-links">
        ...
        <a href="specs.html" class="active">仕様</a>
        <a href="#" class="buy-btn">購入</a>
      </div>
    </div>
  </nav>
  <main class="lp-main">
    <section class="specs-section">
      ...
      <div class="spec-table">
        <div class="spec-row">
          <div class="spec-key">仕上げ</div>
          <div class="spec-val">ブラックチタニウム<br>ホワイトチタニウム</div>
        </div>
        <div class="spec-row">
          <div class="spec-key">容量</div>
          <div class="spec-val">256GB / 512GB / 1TB</div>
        </div>
        <div class="spec-row">
          <div class="spec-key">ディスプレイ</div>
          <div class="spec-val">6.7インチ Super Retina XDR<br>ProMotionテクノロジー</div>
        </div>
      </div>
    </section>
  </main>
...
<div class="notion-clone">
  <aside class="n-sidebar">
    <div class="workspace-switcher">
      <span class="icon">💻</span> My Workspace
    </div>
  ...
  <main class="n-main">
    <header class="n-topbar">
      <div class="breadcrumbs">
        <span>TraceLab プロジェクト</span> <span class="sep">/</span> <span>TraceLab 仕様書</span>
      </div>
...
<div class="notion-clone">
  ...
  <main class="n-main">
    <header class="n-topbar">
      <div class="breadcrumbs">
        <span>TraceLab プロジェクト</span> <span class="sep">/</span> <span>開発ロードマップ</span>
      </div>
    </header>
    <div class="n-editor">
      ...
      <div class="kanban-preview">
        <div class="k-col">
          <h4>To Do</h4>
          <div class="k-card">Web3 LPの追加</div>
        </div>
        <div class="k-col">
          <h4>In Progress</h4>
          <div class="k-card">24インチ対応化</div>
        </div>
        <div class="k-col">
          <h4>Done</h4>
          <div class="k-card">MissionLab完成</div>
        </div>
      </div>
    </div>
  </main>
...
.doc-title[placeholder]:empty:before {
...
<div class="api-docs">
  <aside class="api-sidebar">
    ...
    <nav class="api-nav">
      ...
      <ul>
        <li><a href="index.html" class="active">Authentication</a></li>
    ...
    <div class="p-info-scroll">
      ...
      <div class="p-color-sec">
        ...
        <div class="color-options">
          ...
          <button class="color-btn olive"></button>
          <button class="color-btn navy"></button>
        </div>
      </div>
      ...
      <div class="accordion-wrap">
        <details open>
          ...
          <p>極寒の環境にも耐えうる、最高峰の保温性を持つダウンジャケット。表地には撥水加工を施した高密度ナイロンを使用。</p>
        </details>
        <details>
          <summary>Details & Care</summary>
          <p>素材: ナイロン100%, 中綿: ダウン90% フェザー10%<br>お手入れ: クリーニング専門店にご相談ください。</p>
        </details>
        <details>
          <summary>Shipping & Returns</summary>
          <p>全国送料無料。到着後14日以内は返品可能です。</p>
        </details>
      </div>
    </div>
  </main>
...
<div class="agency-wrap">
  ...
  <div class="parallax-window p-mid">
    <div class="p-content">
      <h2 class="mix-blend">Selected Works</h2>
    </div>
  </div>
  <div class="solid-section">
    <div class="work-gallery">
      <div class="work-item">
        ...
        <p>For Tech Startup</p>
      </div>
      <div class="work-item">
        <h3>E-Commerce</h3>
        <p>Fashion Brand Redesign</p>
      </div>
    </div>
  </div>
</div>
...
.a-links a:hover::after, .a-links a.active::after {
  width: 100%;
}
...
<div class="kanban-app">
  <header class="k-header">
    <div class="k-logo">☑ TaskFlow</div>
    <div class="k-user">
      <a href="index.html" style="color:#fff; text-decoration:none;">⬅ Back to Board</a>
    </div>
  </header>
    ...
    <section class="bk-features">
      ...
      <div class="f-cards">
        <div class="f-card">
          ...
          <p>海を一望できる最上階スイート。プライベートジャグジー完備。</p>
        </div>
        <div class="f-card">
          <h3>Forest Villa</h3>
          <p>森に囲まれた静寂の一棟貸しヴィラ。完全なプライベート空間。</p>
        </div>
      </div>
    </section>
  </main>
  ...
  <main class="bk-results">
    <aside class="bk-sidebar">
      ...
      <div class="filter-box">
        <label><input type="checkbox"> 温泉あり</label>
        <label><input type="checkbox"> 朝食付き</label>
        <label><input type="checkbox"> 禁煙ルーム</label>
      </div>
    </aside>
    <div class="bk-list">
      <div class="room-item">
...
.bk-hero {
  position: relative;
  height: 600px;
  background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://images.unsplash.com/photo-1542314831-c6a4d1429392?w=1200&q=80') center/cover;
  display: flex;
  align-items: center;
  justify-content: center;
}
...
.bg-ocean {
  background-image: url('https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600&q=80');
}
...
<div class="ide-clone">
  ...
  <div class="i-body">
    <aside class="i-activity">
      <div class="i-icon active">📁</div>
    ...
    <main class="i-editor">
      <div class="i-tabs">
        <div class="i-tab active">index.html</div>
        <div class="i-tab">style.css</div>
      </div>
...
<div class="final-boss">
  ...
  <nav class="boss-stages">
    ...
    <button class="st-btn">#28</button>
    <button class="st-btn">#29</button>
    <button class="st-btn active">#30</button>
  </nav>
  <nav class="boss-tabs">
    <button class="t-btn active">🧡 index.html</button>
    <button class="t-btn">💙 style.css</button>
  ...
  <main class="boss-grid">
    <div class="boss-panel">
      ...
      <div class="p-body">
        <div class="p-lines">1<br>2</div>
        <div class="p-code">&lt;!-- FINAL --&gt;</div>
      </div>
    </div>
    <div class="boss-panel">
      <div class="p-head amber">✍️ YOUR EDITOR</div>
      <div class="p-body">
        <div class="p-lines">1</div>
        <textarea class="p-textarea" placeholder="写経せよ..."></textarea>
      </div>
    </div>
...
.boss-panel:nth-child(2) .p-lines {
  background: #141414;
}
