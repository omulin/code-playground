...
const LEARNING_STEPS: LearningStep[] = [
  // --- HTML編 (1-15) ---
  {
    ...
    description: "Webページを作る最初の1行です。", behaviorNote: "ブラウザに最新のHTML5であることを伝えます。",
  ...
  },
  {
    ...
    description: "ページ全体の根幹となるタグです。", behaviorNote: "ここからHTML文書が始まることを示します。",
  ...
  },
  {
    ...
    description: "裏設定のheadと、目に見えるbodyを作ります。", behaviorNote: "headは設定、bodyは画面に映る領域です。",
    codeAnswer: "<head>\n  <title>My Site</title>\n</head>\n<body>\n\n</body>", targetFile: 'html', targetKeyword: '<head>',
    checkpoint: "`<head>` と `<body>` タグを配置してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  \n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 4, title: "STEP 4: タイトルを設定する", category: "HTML",
    description: "ブラウザのタブに表示される名前を決めます。", behaviorNote: "サイトのタイトルを指定します。",
    codeAnswer: "<title>マイポートフォリオ</title>", targetFile: 'html', targetKeyword: '<title>',
    checkpoint: "`<title>` タグでページ名を設定してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <head></head>\n  <body></body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 5, title: "STEP 5: メイン見出し (<h1>)", category: "HTML",
    description: "ページの一番大きなメイン見出しを置きます。", behaviorNote: "サイトの看板となる最も重要な見出しです。",
    codeAnswer: "<h1>My Portfolio</h1>", targetFile: 'html', targetKeyword: '<h1>',
    checkpoint: "`<h1>` タグでメイン見出しを置いてください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <head><title>My Site</title></head>\n  <body>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 6, title: "STEP 6: サブ見出し (<h2>)", category: "HTML",
    description: "セクションごとの見出しを作ります。", behaviorNote: "見出しの階層を整理します。",
    codeAnswer: "<h2>About Me</h2>", targetFile: 'html', targetKeyword: '<h2>',
    checkpoint: "`<h2>` タグを配置してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <head><title>My Site</title></head>\n  <body>\n    <h1>My Portfolio</h1>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 7, title: "STEP 7: 段落 (p)", category: "HTML",
    description: "自己紹介などの文章を入れる段落タグです。", behaviorNote: "きれいなテキストのブロックを作ります。",
    codeAnswer: "<p>こんにちは！フロントエンド学習中です。</p>", targetFile: 'html', targetKeyword: '<p>',
    checkpoint: "`<p>` タグで文章を追加してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <head><title>My Site</title></head>\n  <body>\n    <h1>My Portfolio</h1>\n    <h2>About Me</h2>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 8, title: "STEP 8: 画像の表示 (img)", category: "HTML",
    description: "アイコンや写真を画面に表示します。", behaviorNote: "src属性に画像ファイルのURLを指定します。",
  ...
  {
    step: 9, title: "STEP 9: リンク (a)", category: "HTML",
    description: "外部サイトやSNSへ飛ぶリンクを作ります。", behaviorNote: "href属性に行き先のURLを指定します。",
    codeAnswer: "<a href=\"https://github.com\">GitHubはこちら</a>", targetFile: 'html', targetKeyword: 'href=',
    checkpoint: "`<a href=\"...\">` を配置してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <body>\n    <h1>My Portfolio</h1>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 10, title: "STEP 10: リスト (ul/li)", category: "HTML",
    description: "スキルなどを箇条書きで並べます。", behaviorNote: "リスト項目をきれいに縦に並べます。",
    codeAnswer: "<ul>\n  <li>HTML / CSS</li>\n  <li>JavaScript</li>\n</ul>", targetFile: 'html', targetKeyword: '<li>',
    checkpoint: "`<ul>` と `<li>` で箇条書きを作ってください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <body>\n    <h1>Skills</h1>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 11, title: "STEP 11: カードコンテナ (div)", category: "HTML",
    description: "デザインを当てるためのグループを作ります。", behaviorNote: "class属性を付与して後からCSSで装飾します。",
    codeAnswer: "<div class=\"profile-card\">\n  <h2>プロフィール</h2>\n</div>", targetFile: 'html', targetKeyword: 'class=',
    checkpoint: "`<div class=\"...\">` でグループ化してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <body>\n    \n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 12, title: "STEP 12: インライングループ (span)", category: "HTML",
    description: "特定の部分だけ文字の色を変える準備をします。", behaviorNote: "文章の一部をピンポイントで囲みます。",
    codeAnswer: "<p>私の得意な言語は<span>JavaScript</span>です。</p>", targetFile: 'html', targetKeyword: '<span>',
    checkpoint: "`<span>` タグを配置してください。",
    defaultHtml: "<!DOCTYPE html>\n<html>\n  <body>\n    <p></p>\n  </body>\n</html>", defaultCss: "", defaultJs: ""
  },
  {
    step: 13, title: "STEP 13: 入力フォーム (input)", category: "HTML",
    description: "文字を入力できるテキストボックスを置きます。", behaviorNote: "ユーザーからの入力を受け付けます。",
  ...
  {
    step: 14, title: "STEP 14: ボタン (button)", category: "HTML",
  ...
  {
    step: 15, title: "STEP 15: HTML骨組み完成", category: "HTML",
    description: "ここまでのHTML要素を美しく総まとめします。", behaviorNote: "1枚のホームページのベース骨組みが完成します。",
  ...
  // --- CSS編 (16-30) ---
  {
    step: 16, title: "STEP 16: CSSの読み込み (<link>)", category: "CSS",
  ...
  {
    step: 17, title: "STEP 17: 背景色の変更 (background)", category: "CSS",
  ...
  {
    step: 18, title: "STEP 18: 見出しのデザイン (color/font-size)", category: "CSS",
  ...
  {
    step: 19, title: "STEP 19: 余白と角丸 (padding/border-radius)", category: "CSS",
  ...
  {
    step: 20, title: "STEP 20: 枠線をつける (border)", category: "CSS",
  ...
  {
    step: 21, title: "STEP 21: 立体感を出す (box-shadow)", category: "CSS",
  ...
  {
    step: 22, title: "STEP 22: 幅と高さの指定 (width/height)", category: "CSS",
  ...
  {
    step: 23, title: "STEP 23: 中央寄せ (margin: 0 auto)", category: "CSS",
  ...
  {
    step: 24, title: "STEP 24: 横並びレイアウト (display: flex)", category: "CSS",
  ...
  {
    step: 25, title: "STEP 25: 配置の調整 (justify-content)", category: "CSS",
  ...
  {
    step: 26, title: "STEP 26: 要素の隙間 (gap)", category: "CSS",
  ...
  {
    step: 27, title: "STEP 27: ホバーエフェクト (:hover)", category: "CSS",
  ...
  {
    step: 28, title: "STEP 28: 行間の調整 (line-height)", category: "CSS",
  ...
  {
    step: 29, title: "STEP 29: スマホ対応 (@media)", category: "CSS",
  ...
  {
    step: 30, title: "STEP 30: CSSデザイン総仕上げ", category: "CSS",
  ...
  // --- JavaScript編 (31-45) ---
  {
    step: 31, title: "STEP 31: JSファイルの読み込み (<script>)", category: "JavaScript",
  ...
  {
    step: 32, title: "STEP 32: コンソール出力 (console.log)", category: "JavaScript",
  ...
  {
    step: 33, title: "STEP 33: 変数の宣言 (const)", category: "JavaScript",
  ...
  {
    step: 34, title: "STEP 34: ポップアップ通知 (alert)", category: "JavaScript",
  ...
  {
    step: 35, title: "STEP 35: 要素の取得 (getElementById)", category: "JavaScript",
  ...
  {
    step: 36, title: "STEP 36: 文字の書き換え (textContent)", category: "JavaScript",
  ...
  {
    step: 37, title: "STEP 37: クリックイベント (addEventListener)", category: "JavaScript",
  ...
  {
    step: 38, title: "STEP 38: イベント連動の文字変更", category: "JavaScript",
  ...
  {
    step: 39, title: "STEP 39: スタイルの動的変更 (.style)", category: "JavaScript",
  ...
  {
    step: 40, title: "STEP 40: 条件分岐 (if文)", category: "JavaScript",
  ...
  {
    step: 41, title: "STEP 41: クラスの切り替え (classList)", category: "JavaScript",
  ...
  {
    step: 42, title: "STEP 42: カウンター機能を作る", category: "JavaScript",
  ...
  {
    step: 43, title: "STEP 43: 表示・非表示の切替", category: "JavaScript",
  ...
  {
    step: 44, title: "STEP 44: 入力値の取得 (value)", category: "JavaScript",
  ...
  {
    step: 45, title: "STEP 45: フロントエンドマスター完走！", category: "JavaScript",
    description: "全45ステップのすべての知識を統合してアプリを完成させます。", behaviorNote: "HTML・CSS・JSを完璧にマスターした証です！",
    codeAnswer: "console.log(\"Frontend Master 45 Steps Completed!!\");", targetFile: 'js', targetKeyword: 'console.log',
    checkpoint: "完走のコードを記述して全クリアを達成しよう！",
    defaultHtml: "<!DOCTYPE html>\n<html>\n<body>\n  <h1>Complete!</h1>\n  <script src=\"script.js\"></script>\n</body>\n</html>", defaultCss: "", defaultJs: "console.log(\"Frontend Master 45 Steps Completed!!\");"
  }
];
...
export default function LearningLab() {
  ...
  // 💡 カテゴリを HTML / CSS / JavaScript の3つに限定
  ...
  const handleNext = () => {
    ...
    if (currentStepIdx + 1 < LEARNING_STEPS.length) {
      ...
      alert("🎉 おめでとうございます！！全45ステップを完全走破しました！");
    }
  };
